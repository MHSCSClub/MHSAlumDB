                    ...
                    <div class="col-lg-12">
                        <?php
                            ...
                            if ($num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    $tablecode = $tablecode . '<tr><td><a href="https://alumdb.mamaroneckschoolsfoundation.org/chatv3/sendmail.php?alumniid=' . $row["alumnitable_id"]. '">' . $row["firstName"]. " " . $row["lastName"]. '</a></td><td>' . $row["graduationYear"]. "</td></tr>";
                                }
