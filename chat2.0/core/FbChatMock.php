...
class FbChatMock {
  ...
  public function getMessages() {
    $messages = array();
    $query = "SELECT chat.message, chat.sent_on, message_users.id, message_users.username FROM message_users JOIN chat ON chat.user_id = message_users.id ORDER BY sent_on";
